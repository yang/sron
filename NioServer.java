...
public class NioServer implements Runnable {
    ...
    // Maps a DatagramChannel to a list of ByteBuffer instances
    private Map<DatagramChannel, List<ByteBuffer>> pendingData = new HashMap<DatagramChannel, List<ByteBuffer>>();
    ...
    private void accept(SelectionKey key) throws IOException {
        ...
        DatagramChannel socketChannel = serverSocketChannel.accept();
        socketChannel.configureBlocking(false);

        // Register the new DatagramChannel with our Selector, indicating
